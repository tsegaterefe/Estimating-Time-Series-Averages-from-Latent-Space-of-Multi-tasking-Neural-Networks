...
* Finally, to assess the quality of the estimated time domain per class averages, one nearest centroid classification was conducted using the per class averages and the test split of the [UCR](https://www.cs.ucr.edu/%7Eeamonn/time_series_data_2018/) datasets. 
